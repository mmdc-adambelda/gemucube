...
export const metadata: Metadata = {
  ...
  description: "GemuCube Solutions partners with startups and growing businesses to build systems, automate operations, and scale technology.",
}

const pillars = [
  { id: 'A', icon: Shield, title: 'Business Infrastructure & Scaling', body: 'We design the operational backbone your business runs on — from client onboarding to revenue operations, built to ISO and HIPAA standards.', href: '/solutions#infrastructure' },
  { id: 'B', icon: Zap, title: 'Systems & Automation Engineering', body: 'We connect your tools and eliminate the manual work between them — CRM, automation, cloud architecture, and secure environments.', href: '/solutions#systems' },
  { id: 'C', icon: Globe, title: 'Digital Growth Infrastructure', body: 'We build your digital presence to rank, convert, and represent your business — websites, SEO, analytics, and social media systems.', href: '/solutions#digital' },
  { id: 'D', icon: Server, title: 'Managed IT & Support Operations', body: 'We keep your systems running and your team supported — helpdesk, Microsoft 365, Azure, VoIP, and remote technical support.', href: '/solutions#managed-it' },
  { id: 'E', icon: Users, title: 'Embedded Partnership Model', body: 'We embed as your Fractional CTO or IT Director — making decisions, leading teams, and scaling with your business from the inside.', href: '/solutions#embedded' },
]

const steps = [
  { num: '01', title: 'Discovery Call', body: "We understand your business, systems, and goals — and tell you exactly what we would build and how." },
  ...
  { num: '03', title: 'Build & Embed', body: "We execute as your internal team — not through hand-offs or account managers." },
  { num: '04', title: 'Scale & Operate', body: 'We grow with you. As your business scales, the systems we built scale with it.' },
]

const differentiators = [
  { title: 'Enterprise + Startup Fluency', body: "Adam's career spans SAP Philippines, Emapta, NXTGEN Industries Melbourne, and MEDVA/Deel PH. Renz's spans NXTGEN, Intelegencia, and TaskUs." },
  { title: 'Full-Stack Capabilities', body: 'Business operations, systems engineering, digital growth, managed IT, and embedded leadership — across one partnership. No fragmented vendors.' },
  { title: 'Direct Senior Access', body: "Every engagement involves Adam and/or Renz directly. No account managers. The people with enterprise credentials do the work." },
  { title: 'Embedded, Not Outsourced', body: "GemuCube does not hand off and disappear. We are present in operations, aligned to your goals, and accountable to your outcomes." },
]

const clients = ['NXTGEN Industries', 'MEDVA / Deel PH', 'SAP Philippines', 'Emapta Philippines', 'TaskUs', 'Intelegencia']
...
const who = [
  { tag: 'Startups', title: 'Building From Zero', body: "You are building your operational foundation — systems, processes, and infrastructure. You need a technical partner who has done this inside enterprise environments." },
  { tag: 'Growing SMBs', title: 'Scaling Operations', body: "Your team is growing and your manual processes are breaking. You need systems that scale with you, and a team that can build and operate them." },
  { tag: 'Enterprises', title: 'Modernizing Systems', body: "You have legacy infrastructure and a mandate to modernize without disrupting operations. You need someone who has been inside enterprise systems at SAP and NXTGEN level." },
]
  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center pt-[72px] overflow-hidden grid-bg noise">
        ...
        <div className="glow-orb w-[400px] h-[400px] bg-[#FFDB49] opacity-[0.04] bottom-0 right-0 animate-glow-pulse" />
        ...
        <div className="absolute right-8 top-1/2 -translate-y-1/2 hidden xl:grid grid-cols-2 gap-2 opacity-[0.07] animate-float select-none pointer-events-none" aria-hidden>
          {['G','E','M','U'].map((l, i) => (
            <div key={l} className={`w-28 h-28 flex items-center justify-center text-5xl font-display font-bold rounded-sm ${i % 2 === 0 ? 'bg-[#FFDB49] text-black' : 'bg-white/10 text-white'}`}>
              {l}
            </div>
          ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-28">
          <div className="flex items-center gap-3 mb-8">
            ...
            <p className="eyebrow">Business &amp; IT Partnership Firm &middot; Philippines</p>
          </div>

          <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl xl:text-8xl leading-[1.05] mb-8 max-w-5xl">
            We Don&apos;t Work<br />
            <span className="text-gradient">For You.</span><br />
            We Build With You.
          </h1>

          <p className="text-white/60 text-lg sm:text-xl max-w-2xl leading-relaxed mb-12">
            GemuCube Solutions partners with startups and scaling businesses to design, build, and operate
            their systems, operations, and technology — as a genuine extension of their team.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/solutions" className="btn-ghost">See Our Solutions</Link>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-20 pt-12 border-t border-white/[0.06]">
            {stats.map((s) => (
              <div key={s.value}>
      ...
      <section className="section-pad bg-[#0e0e0e] relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-white/50 text-lg mb-16 max-w-2xl">
            Three types of businesses engage GemuCube. If you are in one of these categories, we already know what you need.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {pillars.map((p) => {
              const Icon = p.icon
              return (
                <Link key={p.id} href={p.href} className="glass-card rounded-lg p-6 relative overflow-hidden group block">
      ...
      <section className="section-pad bg-[#0a0a0a] grid-bg relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h2 className="font-display text-4xl sm:text-5xl text-white mb-16">How a real partnership begins.</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, i) => (
              <div key={step.num} className="relative">
                {i < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-8 h-[1px] bg-gradient-to-r from-[rgba(255,219,73,0.3)] to-transparent" style={{ width: 'calc(100% - 2rem)', left: '2rem' }} />
                )}
      ...
      <section className="section-pad relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h2 className="font-display text-4xl sm:text-5xl text-white mb-16 max-w-2xl">What makes us different from every other firm.</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {differentiators.map((d) => (
              <div key={d.title} className="glass-card rounded-lg p-8">
      ...
      <section className="py-16 border-y border-white/[0.06] bg-[#0e0e0e]">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-center text-white/30 text-xs font-mono tracking-widest uppercase mb-10">Work history includes</p>
      ...
      <section className="section-pad relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative">
          ...
          <p className="text-white/50 text-lg mb-10 leading-relaxed">No pitch decks. No generic proposals. Just a direct talk about your business.</p>
          <Link href="/contact" className="btn-primary group text-base py-4 px-8">
            Schedule a Discovery Call
            <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
          </Link>
          <p className="text-white/25 text-xs mt-6 font-mono">You will hear directly from Adam or Renz within 24 hours.</p>
        </div>
      </section>
    </div>
  )
